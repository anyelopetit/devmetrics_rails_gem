...
module Devmetrics
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      desc "Installs DevMetrics: copies migrations and creates an initializer."
      ...
      def create_initializer
        template "initializer.rb", "config/initializers/devmetrics.rb"
      end
      ...
      def mount_instructions
        route_exists = File.read("config/routes.rb").include?("devmetrics")
        if route_exists
        ...
        say "    require 'devmetrics'\n"
        say "    RSpec.describe 'Posts API', devmetrics: true do\n"
        say "      ...\n"
        say "    end\n\n"
