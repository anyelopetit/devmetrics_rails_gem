Gem::Specification.new do |s|
  ...
  s.version     = "0.1.0"
  s.authors     = [ "DevMetrics Live Contributors" ]
  s.email       = []
  s.homepage    = "https://github.com/yourusername/devmetrics_live"
  s.summary     = "Real-time Rails performance dashboard via Solid Cable"
  s.description = <<~DESC
    DevMetrics Live is a mountable Rails Engine that adds a live performance
